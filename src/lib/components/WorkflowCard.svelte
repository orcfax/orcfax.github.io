            ...
            transition-duration: {$currentIndex === index ? `${collapseDelay}ms` : '0s'};"
                          ...
                          transition-duration:
                            {$currentIndex === index ? `${collapseDelay}ms` : '0s'};"
                                ...
                                <div class="space-y-2">
                                    <h3 class="text-lg lg:text-2xl font-bold text-primary/90">
                                        {item.title}
                                    </h3>
                                    <div class="text-[16px] w-96 text-primary/80">
                                        {item.content}
                                    </div>
                                </div>
                            </div>
                ...
                <div class={`h-[350px] min-h-[200px] w-auto ${ltr && "lg:order-1"}`}>
                    {#if data[$currentIndex]?.image}
                        <img
                            ...
                            alt="feature"
                            class="aspect-auto size-lg rounded-xl border border-neutral-300/50 object-cover object-left-top p-1 shadow-lg"
                        />
