...
<div
  class="bg-primary w-full mx-auto px-6 lg:max-w-7xl lg:px-8 flex flex-col items-center"
>
  ...
  <div
    class="flex flex-col xs:flex-row items-start xs:items-center justify-center pt-10 gap-0"
  >
    ...
    >
      <div class="flex flex-col gap-4">
        <h1 class="text-2xl font-bold font-mulish text-secondary">
          Validator License NFT
        </h1>
        <div class="flex flex-col gap-4">
          <p class="text-secondary max-w-xl">
            The Validator License is an NFT that grants holders the right to
            operate an Orcfax validator node in the Orcfax decentralized
            validator network.
          </p>
          <p class="text-secondary max-w-xl">
            Orcfax validators are software nodes run by a decentralized network
            of operators around the world. These nodes collect, validate,
            publish, and archive real-world data on-chain.
          </p>
          <p class="text-secondary max-w-xl">
            The Orcfax Validator License NFT <Link
              href="https://medium.com/@orcfax/orcfax-validator-license-mint-032c327135d4"
              isNewTab>mint</Link
            > was completed on 2024-04-18. However, licenses can be purchased on
        ...
        <div class="flex flex-col gap-4">
          <p class="text-secondary max-w-xl">
            Orcfax's ongoing Incentivized Testnet (ITN) is a major step in
            enhancing the decentralized infrastructure of blockchain oracles on
            Cardano.
          </p>
          <p class="text-secondary max-w-xl">
          ...
          <p class="text-secondary max-w-xl">
            This initiative is preparing the Orcfax network for a smooth
            transition from our current federated node model to a fully
            decentralized model.
          </p>
          <p class="text-secondary max-w-xl">
            For more information on the ITN, you can read the
            <Link href="https://docs.orcfax.io/itn-overview" isNewTab
              >ITN Docs</Link
