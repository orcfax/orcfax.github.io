<script lang="ts">
  ...
  let useCases: UseCase[] = [
    ...
    },
    {
      ...
      description:
        "Distribute data validation across multiple blockchain oracle services to ensure reliability and reduce single points of failure. Create a robust network of data providers for critical blockchain applications.",
      icon: Shield,
    },
    {
  ...
  function updateCurrentIndex() {
    ...
    currentIndex = Math.max(
      0,
      Math.min(newIndex, useCases.length - itemsPerView),
    );
  }
...
<div class="bg-primary">
  <div class="mx-auto">
    ...
    <div class="mx-auto mt-8 relative overflow-hidden">
      <div
        class="carousel w-full overflow-x-auto relative z-0"
        bind:this={carousel}
      >
      ...
      <div class="absolute inset-0 pointer-events-none">
        {#if currentIndex > 0}
          <div
            class="absolute left-0 top-1/2 -translate-y-1/2 h-10 pointer-events-auto"
          >
            <button
        ...
        {#if currentIndex < useCases.length - itemsPerView}
          <div
            class="absolute right-0 top-1/2 -translate-y-1/2 h-10 pointer-events-auto"
          >
            <button
