...
<div class="bg-accent py-24 pt-16">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
            ...
            >
                <div
                    class="relative pl-16 bg-primary rounded-lg p-8 shadow-xl hover:shadow-2xl transition-shadow duration-300"
                >
                ...
                <div class="relative pl-16">
                    <dt class="text-base/7 font-semibold text-gray-900">
                        <div
                            class="absolute left-0 top-0 flex size-10 items-center justify-center rounded-lg bg-secondary"
                        >
                            <svg
                    ...
                    <dd class="mt-2 text-base/7 text-primary">
                ...
                <div class="relative pl-16">
                    <dt class="text-base/7 font-semibold text-gray-900">
                        ...
                        Best-in-class Archival Standards
                    </dt>
                    <dd class="mt-2 text-base/7 text-primary">
                        Arcu egestas dolor vel iaculis in ipsum mauris. Tincidunt mattis aliquet hac
                        quis. Id hac maecenas ac donec pharetra eget.
                ...
                <div class="relative pl-16">
                    <dt class="text-base/7 font-semibold text-primary">
                        <div
                            class="absolute left-0 top-0 flex size-10 items-center justify-center rounded-lg bg-secondary"
                        >
                            <svg
