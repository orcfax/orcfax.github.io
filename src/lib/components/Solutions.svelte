...
<div class="bg-primary">
  <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
    <div class="mx-auto max-w-3xl lg:text-center">
      <h1
        class="mt-2 text-5xl lg:text-6xl font-bold font-mulish text-secondary text-center"
      >
        Data Feed Solutions
      </h1>
    ...
    <div class="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
        ...
        >
          <div class="px-8 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
            ...
            <p class="mt-2 max-w-lg text-sm/6 text-secondary">
              To learn more about the available feeds, feed types, and feed
              support models, refer to our <a
          ...
          >
            ...
            >
              <img
                class="size-full object-cover object-top p-2"
                src="./Explorer.png"
                alt=""
              />
            </div>
        ...
        >
          ...
          <div class="px-8 sm:px-10 -mt-6 pb-8">
            ...
            <p class="mt-2 max-w-lg text-sm/6 text-secondary">
              ...
              Perfect for systems that need on-chain data on a regular basis.
            </p>
          </div>
        </div>
        <div
      ...
      <div class="relative lg:row-span-2 order-4">
        ...
        >
          <div
            class="flex flex-col gap-2 px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10"
          >
            <div>
              <p
                class="mt-2 text-lg font-semibold tracking-tight text-secondary"
              >
              ...
              <p class="mt-2 max-w-lg text-sm/6 text-secondary">
                Read our <a
                  ...
                  target="_blank"
                  class="text-accent underline text-sm/6">developer manual</a
                >
                for integration details and check out our
                <a
                  href="https://github.com/orcfax/orcfax-examples"
                  target="_blank"
                  class="text-accent underline text-sm/6">examples</a
                >
                of demo dApps that utilize Orcfax Data Feeds.
              </p>
            </div>
            <div>
              <p
                class="mt-6 text-lg font-semibold tracking-tight text-secondary"
              >
                Build with Orcfax
              </p>
              <p class="mt-2 max-w-lg text-sm/6 text-secondary">
                We are open to exploring custom blockchain oracle solutions for
                interested and aligned projects such as:
              </p>
              <ul class="list-disc list-inside">
                <li class="text-sm/6 text-secondary">New feed types</li>
                <li class="text-sm/6 text-secondary">Custom data sources</li>
                <li class="text-sm/6 text-secondary">Custom data processing</li>
                <li class="text-sm/6 text-secondary">Collaborative research</li>
              </ul>
            </div>
            <div class="pb-8">
              <p
                class="my-4 text-lg font-semibold tracking-tight text-secondary"
              >
                For help & support
              </p>
              <div class="flex flex-col justify-center gap-4 mt-2 bg-card">
                ...
                >
                <Link href="https://x.com/orcfax" isNewTab isButton
