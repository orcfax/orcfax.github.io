  ...
  const teamMembers: TeamMember[] = [
    ...
    },
    {
      ...
      links: [
        ...
        {
          type: "linkedin",
          url: "https://ca.linkedin.com/in/petervangarderen",
        },
    ...
    },
    {
      ...
      links: [
        ...
        {
          type: "linkedin",
          url: "https://www.linkedin.com/in/ross-spencer-b6b9b758/--",
        },
      ],
    },
    ...
    },
    {
      ...
      links: [
        ...
        {
          type: "linkedin",
          url: "https://www.linkedin.com/in/gabriel-chartier/",
        },
      ],
    },
    {
...
>
  <div
    class="mx-auto flex flex-col items-center max-w-7xl gap-10 xl:grid-cols-3"
  >
    <div class="max-w-xl">
      <h2
      ...
      <p class="mt-6 text-lg/8 text-secondary font-mulish text-center">
        We are a lean and dedicated team with deep expertise in archival
        science, digital preservation, and blockchain tech.
      </p>
    </div>
    <ul
      role="list"
